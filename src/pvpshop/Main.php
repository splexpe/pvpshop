...
use pvpshop\Modals\elements\{Dropdown, Input, Button, Label, Slider, StepSlider, Toggle};
...
class Main extends PluginBase implements Listener {
    ...
    */
    ...
    public function onEnable(){
        ...
        $this->item = [$this->Potions, $this->Armor];
    }

    public function sendMainShop(Player $player){
        $ui = new SimpleForm("§cPvp Shop");
